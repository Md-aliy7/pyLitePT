...
class GUI(QtWidgets.QMainWindow):
    def __init__(self, control: "Controller") -> None:
        ...
        if self.startup_dialog.exec():
            ...
            sys.exit()
        # Unified mode: always show both segmentation and detection tools
        # (button_assign_label for seg, bbox tools for det)
        # Only hide for pure OBJECT_DETECTION mode (legacy compatibility)

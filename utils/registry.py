...
class Registry:
    ...
    def register_module(self, name=None, force=False, module=None):
        ...
        if isinstance(name, type):
             raise TypeError(
                "module must be a class, but got {type(name)}. "
                "Registering with a class as the first argument is no longer supported. "
                "detectron2's Registry now requires 'name' as the first argument."
            )

    ...
    def get_data_list(self):
        ...
        for split in split_list:
            if os.path.isfile(os.path.join(self.data_root, split)):
                ...
                # Filter to ensure valid scenes (must have coord.npy)
                all_folders = glob.glob(os.path.join(self.data_root, split, "*"))
                for folder in all_folders:
                    if os.path.exists(os.path.join(folder, 'coord.npy')):
